...
const TestCasesLanding: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Select a workspace to manage test cases</p>
      </div>
      {isLoading ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {workspaces.map((ws) => (
            <Link key={ws.id} to={`/qa/workspaces/${ws.id}/test-cases`}>
...
export default TestCasesLanding;
